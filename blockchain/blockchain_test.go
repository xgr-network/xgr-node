...
func TestBlockchain_CalculateBaseFee(t *testing.T) {
	...
	tests := []struct {
		...
		{6, chain.GenesisBaseFee, 20000000, 10000000, chain.MinBaseFee, 2}, // below critical threshold -> clamp to min
		{6, chain.GenesisBaseFee, 20000000, 10000000, chain.MinBaseFee, 4}, // below critical threshold -> clamp to min
		{6, chain.GenesisBaseFee, 20000000, 9000000, chain.MinBaseFee, 2},  // below critical threshold -> clamp to min
		{6, chain.GenesisBaseFee, 20000000, 9000000, chain.MinBaseFee, 4},  // below critical threshold -> clamp to min
		{6, chain.GenesisBaseFee, 20000000, 11000000, chain.MinBaseFee, 2}, // below critical threshold -> clamp to min
		{6, chain.GenesisBaseFee, 20000000, 11000000, chain.MinBaseFee, 4}, // below critical threshold -> clamp to min
		{6, chain.GenesisBaseFee, 20000000, 20000000, 125000000000, 2},     // above threshold -> emergency ramp (+25%)
		{6, chain.GenesisBaseFee, 20000000, 20000000, 125000000000, 4},     // above threshold -> emergency ramp (+25%)
		{6, chain.GenesisBaseFee, 20000000, 0, chain.MinBaseFee, 2},        // usage 0 -> clamp to min
		{6, chain.GenesisBaseFee, 20000000, 0, chain.MinBaseFee, 4},        // usage 0 -> clamp to min
	}
