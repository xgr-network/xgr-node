...
This command funds the initialized accounts via `xgrchain polybft-secrets` command.

```bash
$ xgrchain rootchain fund --data-dir data-dir- --num 2
```

or

```bash
$ xgrchain rootchain fund --data-dir data-dir-1
```
