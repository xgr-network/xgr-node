...
import (
	...
	"github.com/xgr-network/xgr-node/command/server/config"
	"github.com/xgr-network/xgr-node/command/server/export"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the XGRChain client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing XGRChain client data",
	)
	...
	cmd.Flags().BoolVar(
		...
		"start the state sync relayer service",
	)
