...
3. Get trie root
    ...
    ```bash
    ./xgrchain regenesis getroot --rpc "http://localhost:10002"
...
4. Make trie snapshot
    ...
    ```bash
    ./xgrchain regenesis --target-path ./trie_new --stateRoot 0xf5ef1a28c82226effb90f4465180ec3469226747818579673f4be929f1cd8663  --source-path ./test-chain-1/trie 
...
6. Create new validators
    ...
    ```bash
    ./xgrchain polybft-secrets --insecure --data-dir test-chain- --num 4
...
7. Generate genesis file
    ...
    ```bash
    ./xgrchain genesis --consensus polybft \
...
8. Try to start a new v0.7 chain
    ...
    ```bash
    ./xgrchain server --data-dir ./test-chain-1 --chain genesis.json --grpc-address :10000 --libp2p :30301 --jsonrpc :10002 --seal --log-level DEBUG &
    ./xgrchain server --data-dir ./test-chain-2 --chain genesis.json --grpc-address :20000 --libp2p :30302 --jsonrpc :20002 --seal --log-level DEBUG &
    ./xgrchain server --data-dir ./test-chain-3 --chain genesis.json --grpc-address :30000 --libp2p :30303 --jsonrpc :30002 --seal --log-level DEBUG &
    ./xgrchain server --data-dir ./test-chain-4 --chain genesis.json --grpc-address :40000 --libp2p :30304 --jsonrpc :40002 --seal --log-level DEBUG &
    wait
    ...
    [1]    exit 1     ./xgrchain server --data-dir ./test-chain-1 --chain genesis.json  :10000 
    ...
    invalid initial state root
    [3]  - exit 1     ./xgrchain server --data-dir ./test-chain-3 --chain genesis.json  :30000 
    invalid initial state root
    [2]  - exit 1     ./xgrchain server --data-dir ./test-chain-2 --chain genesis.json  :20000 
    invalid initial state root
    [4]  + exit 1     ./xgrchain server --data-dir ./test-chain-4 --chain genesis.json  :40000 
    ```
