...
Running `xgrchain` local cluster with docker can be done very easily by using provided `scripts` folder
...
Use `docker/local/xgrchain.sh` script to customize chain parameters.
