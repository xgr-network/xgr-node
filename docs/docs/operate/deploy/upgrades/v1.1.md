...
[Reference CheckpointManager.sol](https://github.com/xgr-network/core-contracts/blob/2de13ae801cb2e9b50bce7f062b5a86dcbd149dc/contracts/root/CheckpointManager.sol#L197)

**Client Side:** The calculation is: `aggVotingPower >= math.Ceil(2 * totalVotingPower) / 3)`
[Reference validator_set.go](https://github.com/xgr-network/xgr-node/blob/develop/consensus/polybft/validator/validator_set.go#L113)
