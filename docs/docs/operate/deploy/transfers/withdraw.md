...
For a detailed understanding of how bridging works, please refer to the sequence diagrams available [<ins>here</ins>](https://github.com/xgr-network/xgr-node/blob/develop/docs/bridge/sequences.md).
...
```bash
 ./xgrchain bridge withdraw-erc20 \
...
```bash
./xgrchain bridge withdraw-erc721 \
...
```bash
./xgrchain bridge withdraw-erc1155 \
