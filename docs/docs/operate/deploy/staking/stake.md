...
Each validator needs to perform initial staking on the rootchain `StakeManager` contract. This is done using the `xgrchain root stake` command. **Note that this command is for testing purposes only.**
...
```bash
   ./xgrchain polybft supernet --private-key 0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef \
