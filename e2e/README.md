...
The implemented E2E tests start a local instance of xgrchain.
...
### Check if the xgrchain process is running

If you've stopped the tests abruptly, chances are the xgrchain process is still running on your machine. <br/ >
In order for the tests to function normally, please kill the possible remaining processes using `killall xgrchain`
